...
auto_complete.click()
text_wrt = driver.find_element(By.XPATH,'//*[@id="searchbox"]')
...
date_pic.click()
date_clk = driver.find_element(By.XPATH,'//*[@id="ui-datepicker-div"]/table/tbody/tr[2]/td[5]/a')
date_clk.click()
date_next = driver.find_element(By.ID,'datepicker2')
date_next.click()
date_clic = driver.find_element(By.XPATH,'/html/body/div[2]/div/div[2]/div/table/tbody/tr[3]/td[2]/a')
date_clic.click()
time.sleep(5)
switch_widges = driver.find_element(By.LINK_TEXT, 'Widgets')
action.move_to_element(switch_widges).perform()
...
slider_move.click()
#ActionChains(driver).drag_and_drop_by_offset(slider_move,90,0).perform()
#ActionChains(driver).click_and_hold(slider_move).drag_and_drop_by_offset(slider_move,0,70).perform()
slide_movee = driver.find_element(By.XPATH,'//*[@id="slider"]/a')
ActionChains(driver).click_and_hold(slide_movee).drag_and_drop_by_offset(slide_movee,400,0).perform()